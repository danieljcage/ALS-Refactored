...
namespace AlsOverlayModeTags
{
	...
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PistolDualWield)
	...
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Throwable)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Swingable)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Smoking)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HandsBehindHead)
}
